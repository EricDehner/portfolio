            ...
            <motion.section className="menu" initial={{ opacity: 0, x: "100%" }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: "100%", transition: { duration: 0.3, delay: 0 } }} transition={{ duration: 0.3, delay: 0 }}>
                ...
                <div className="menu_section">
                    <li className="navBar_section-items">
                        <Link className="navBar_section-items--item" to="sobreMi" spy={true} smooth={true} offset={-90} duration={700} onClick={handleLinkClick}>
                            SOBRE MI
                        </Link>
                    </li>
                    <li className="navBar_section-items">
                        <Link className="navBar_section-items--item" to="proyectos" spy={true} smooth={true} offset={-150} duration={700} onClick={handleLinkClick}>
                            PROYECTOS
                        </Link>
                    </li>
                    <li className="navBar_section-items">
                        <Link className="navBar_section-items--item" to="contacto" spy={true} smooth={true} offset={-85} duration={700} onClick={handleLinkClick}>
                            CONTACTO
                        </Link>
                    </li>
                </div>
                <article className="menu_footer">
                    ...
                    <a draggable={false} href="https://www.linkedin.com/in/eric-dehner/" target="_blank" rel="noreferrer">
                        Eric Dehner
                    </a>
                </article>
            </motion.section>
